...
urlpatterns = [
    ...
    path('password-change', auth_views.PasswordChangeView.as_view(template_name='registration/password/password_change.html')),
    path('password-change/done', auth_views.PasswordChangeDoneView.as_view(template_name='registration/password/password_change_done.html')),
